...
class Args():
    def __init__(self):
        self.config = './config/train_again-c4s.yaml'
        self.load = 'checkpoints/again/c4s'
        self.source = 'data/wav48/p225/p225_001.wav'
        self.target = 'data/wav48/p226/p226_001.wav'
        self.output = 'data/generated'
        self.dsp_config = './config/preprocess.yaml'
        self.seed = 961998
        self.seglen = None
